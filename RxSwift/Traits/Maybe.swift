...
extension PrimitiveSequenceType where TraitType == MaybeTrait {
     ...
     */
    static func create(subscribe: @escaping (@escaping MaybeObserver) -> Disposable) -> PrimitiveSequence<TraitType, ElementType> {
     ...
     */
    func subscribe(onSuccess: ((ElementType) -> Void)? = nil,
...
extension PrimitiveSequenceType where TraitType == MaybeTrait {
     ...
     */
    static func just(_ element: ElementType) -> Maybe<ElementType> {
    ...
    /**
     ...
     - returns: An observable sequence containing the single specified element.
     */
    static func just(_ element: ElementType, scheduler: ImmediateSchedulerType) -> Maybe<ElementType> {
     ...
     */
    static func error(_ error: Swift.Error) -> Maybe<ElementType> {
     ...
     */
    static func never() -> Maybe<ElementType> {
     ...
     */
    static func empty() -> Maybe<ElementType> {
...
extension PrimitiveSequenceType where TraitType == MaybeTrait {
     ...
     */
    func `do`(onNext: ((ElementType) throws -> Void)? = nil,
     ...
     */
    func filter(_ predicate: @escaping (ElementType) throws -> Bool)
        -> Maybe<ElementType> {
     ...
     */
    func map<R>(_ transform: @escaping (ElementType) throws -> R)
        -> Maybe<R> {
     ...
     */
    func flatMap<R>(_ selector: @escaping (ElementType) throws -> Maybe<R>)
        -> Maybe<R> {
     ...
     */
    func catchErrorJustReturn(_ element: ElementType)
